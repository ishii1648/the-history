...
> worldmonitor プロジェクトの実装を参考に、戦史マップサービスで活用できる MAP
> 生成関連の知見をまとめる。
...
従来のタイル配信は `/{z}/{x}/{y}.png`
のように1枚ずつHTTPリクエストが必要だった。PMTiles
は全タイルを1ファイルにまとめ、HTTP Range Request で必要部分だけ取得する。
  ...
  style: {
    ...
    sources: {
      basemap: {
        ...
        attribution:
          '<a href="https://protomaps.com">Protomaps</a> | <a href="https://openstreetmap.org/copyright">OSM</a>',
      },
    },
...
const overlay = new MapboxOverlay({
  ...
  layers: [
    ...
    new ScatterplotLayer({
      ...
      getFillColor: (d) =>
        d.result === "victory" ? [0, 128, 255] : [255, 64, 64],
    }),
    // 進軍ルート
    new PathLayer({
      id: "march-routes",
